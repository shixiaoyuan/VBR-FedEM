'''
Created by Yuan Shi, 2024-12, core implementation of VBR
'''
...
class Model(Base):
    ...
    def train_client(self,loader,steps=1):
        ...
        return {'acc': accMeter.average(), 'loss': lossMeter.average(),  'regCMI': regCMIMeter.average(), 'regNegEnt': regNegEntMeter.average()}
